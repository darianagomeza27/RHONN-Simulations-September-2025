...
if __name__ == "__main__":
    ...
    ukf = UKF_Trainer(n_states, eta=0.9)  # Use optimized_ukf['eta'], etc. if optimized
    pf = PF_Trainer(n_states, n_particles=800)  # Use optimized_pf['n_particles'] if optimized
